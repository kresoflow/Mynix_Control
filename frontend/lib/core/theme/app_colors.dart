...
abstract class AppColors {
  ...
  static Color lightBg        = const Color(0xFFE6F0FA);
  static Color lightSurface   = const Color(0xFFFFFFFF);
  static Color lightCard      = const Color(0xFFFFFFFF);
  static Color lightBorder    = const Color(0xFFCDE0F5);
  static Color lightText      = const Color(0xFF0C4A6E);
  static Color lightSubtext   = const Color(0xFF0369A1);
  ...
  static void applyPalette(dynamic palette) {
    if (palette is String) {
      applyThemeVariant(palette);
    } else {
      applyThemeVariant(palette.toString().split('.').last);
    }
  }
}
